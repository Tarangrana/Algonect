...
(10, 33, 21, 'Yeah! I think there is problem in line no 9.', '2025-04-03 16:32:12'),
(11, 35, 22, 'Yeah i agree too!', '2025-04-03 16:36:50');
...
(69, 34, 21, '2025-04-03 16:31:46'),
(70, 33, 21, '2025-04-03 16:31:48'),
(71, 35, 21, '2025-04-03 16:35:07'),
(72, 36, 21, '2025-04-03 16:35:09'),
(73, 36, 22, '2025-04-03 16:36:35'),
(74, 35, 22, '2025-04-03 16:36:36'),
(75, 34, 22, '2025-04-03 16:36:37'),
(76, 33, 22, '2025-04-03 16:36:39'),
(77, 37, 20, '2025-04-03 16:38:44'),
(78, 36, 20, '2025-04-03 16:38:45'),
(79, 35, 20, '2025-04-03 16:38:47');
...
(35, 21, 'Why I Love PHP', 'PHP might be old school, but it\'s still powerful and super easy to deploy on shared hosting!', 'general', '2025-04-03 16:31:41', 'post_images/1743697901_download (1).jpeg'),
(36, 21, 'Session expired while testing login 🔐⏳', 'Had to log in 5 times to debug login.php. I\'m done.', 'rant', '2025-04-03 16:35:02', NULL),
(37, 22, 'How do I store form data in MySQL? 💾', 'Do I need to sanitize it first? What’s the best practice?', 'question', '2025-04-03 16:36:29', NULL),
(38, 20, 'What’s better for layout: Flexbox or Grid? 📐', 'I know both are powerful but which one is preferred for responsive design?', 'question', '2025-04-03 16:38:40', NULL);
...
(20, 'Sagar Ghimire', 'sagar@algomau.ca', '$2y$10$1pZtMuQMyYKaM.UJhiNbDOIJJ/kBMtioR59e1CcsI2xl8DDvRZCDa', '2003-11-17', 'Male', '2025-04-02 16:42:20', 'pics/67eeb96d42ef3_bunnyguk⁷_rest♡RONG DAY🎂 on Twitter _ Blue cartoon character, Pokemon, Cute pokemon wallpaper.jpeg'),
(21, 'Ram Thapa', 'ram@algomau.ca', '$2y$10$XWWF6VyPrSUWoteF2hiGN.6SRjtXkEzINtU8eoteCVjgoDA150Z8K', '2002-11-17', 'Male', '2025-04-03 16:30:30', 'pics/67eeb81fcb219_❖ Iᴄᴏɴ Dᴇ Nᴀʀᴜᴛᴏ Uᴢᴜᴍᴀᴋɪ ❖.jpeg'),
(22, 'Subash Rana', 'subash@algomau.ca', '$2y$10$ukeVLjmN5qGgmOGNlqt3guwVbwCUmifIGPigi8CoOcuO0yEoUMIte', '2003-12-18', 'Male', '2025-04-03 16:35:52', 'pics/67eeb9416d475_★.jpeg');
